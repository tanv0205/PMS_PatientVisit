...
using Vital_BusinessLogic.Implementation;
using Vital_BusinessLogic.Interface;
using Vital_BusinessLogic;
using AutoMapper;
using PMS_VitalSigns.Models;
using System.Text;
using Microsoft.AspNetCore.Authentication.JwtBearer;
using Microsoft.IdentityModel.Tokens;

namespace PMS_VitalSigns
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo { Title = "Vital Signs API", Version = "v1" });
            });
